...
{
    /**
     * ANASAYFA - 11 BUTON YAPISI (Admin Paneli ÇIKARILDI!)
     * Tüm kullanıcılar görebilecek butonlar
     */
    public function getHomepageButtons(Request $request): JsonResponse
    {
        $buttons = [
        ...
        return response()->json([
            'ok' => true,
            'message' => 'Bu anasayfa 11 BUTON için tasarlanmıştır. Admin Paneli AYRI bir route\'da (/admin)!',
    ...
    {
        $allButtons = $this->getHomepageButtons(new Request())->json()['buttons'];
